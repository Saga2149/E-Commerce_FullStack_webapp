...
public class AdvertismentController {
	...
	public Response addAdvert(@FormDataParam("addImageSelect") InputStream file,
		...
		//System.out.println("\nProduct Name: " + name + "\nCategory: " + category + "\nBirthday: " + bday);
 		...
 		String uploadedFileLocation = "/home/saga/Desktop/SEM 2/OOAD/amazoncopy/amazon.com/src/main/webapp/images/advertisments/" + productname + "." +  fileDetail.getFileName().split("\\.")[1];
