	...
	@Path("/products")
	 ...
	 @POST 
		...
		public Response registercus(
		 ...
		 String uploadedFileLocation = "/home/saga/Desktop/SEM 2/OOAD/amazoncopy/amazon.com/src/main/webapp/images/products/" + productname + "." +  fileDetail.getFileName().split("\\.")[1];
