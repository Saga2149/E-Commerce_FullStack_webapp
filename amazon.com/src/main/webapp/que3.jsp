 ...
 */
	        				for (var i in result){
	        					...
	        					if(result[i].quantityleft <  $("#MinPrice").val() || result[i].quantityleft > $("#MaxPrice").val()) 
 ...
 */	        							/*|| ($("#temp1_valuedropdown option:selected").text().toLowerCase() != result[i].temp1_value.toLowerCase() && $("#temp1_valuedropdown option:selected").text().toLowerCase() != "none" )
	        			    ...
	        			    while(currentCount < data.length) {
	        			    	if(currentCount % 4 == 0) {
	        			    		...
	        			    		items = items + "<figcaption class='info-wrap'><a href='#' class='title'>"+data[currentCount].productid+"</a>";
	        			    		items = items + "<figcaption class='info-wrap'><a href='#' class='title'>"+data[currentCount].quantityleft+"</a>";
	        			    		items = items + "<div class='price-wrap h5'><a href='#' class='price-new'>"+data[currentCount].discountedprice+"</a><small><br/><del class='price-old'>"+data[currentCount].price+"</del></small></div></figcaption>";
	        			    		items = items + "</figure></div>";
	        			    		currentCount++;	
	        			    }
		...
		<ul class="list-inline">
		  ...
		  <li class="list-inline-item">
		  	<div class="form-inline">
				...
				<input id="MaxPrice" class="form-control form-control-sm" placeholder="Max" type="number" value="1000">
