...
<nav class="navbar navbar-expand-lg navbar-light">
  <div class="container row">
	...
	<!-- Small Ad -->
	<div class="col-md-4">
		<span class="pull-right"><h3>Sagar Jhunjhunwala (MT2018097)</h3></span>
	</div>
	<!-- Small Ad End -->
  </div>
</nav>
...
<div class="row-sm align-items-center">
	...
	<div class="col-lg-10-24 col-sm-8 small text-light">
		 <a class="text-light text-margin" href="addAddress.html">My Address</a> <a  class="text-light text-margin" href="customer_orders.html" id="myAmazon">My Orders</a> <a  class="text-light text-margin"  href="card_details.html">My Cards</a> <!-- <a class="text-light text-margin" href="Bank.html">Amazon Pay</a> --> <a class="text-light text-margin" href="addprd.html">Sell</a> <a class="text-light text-margin" href="manage_sales.html">Customer Service</a> <a class="text-light text-margin" href=que1.jsp>EndEx2/Q1</a> <a class="text-light text-margin" href=que2.jsp>EndEx2/Q2Q3</a> 	</div> <!-- col.// -->
